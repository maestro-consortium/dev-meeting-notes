...
### Technical discussions
 ...
 - [name=Guilhem] nix lib
     - circular packaging with release/packages (internal dependencies)
     - maestro impact : for nix packages, flake will have a new dependency (new imput)
         - new recipes, boilerplate code, avoids copy/paste
 - [name=Wilson] eigen 5 ABI
     - no time for this (Joris)
     - look at feedstock for eigenpy/nanoeigenpy. 
         - Wilson to look

#### stack-of-tasks/pinocchio

 - Items to discuss:
   - [#2851 [Feature]: Batch Computation](https://github.com/stack-of-tasks/pinocchio/issues/2851)
        - see also discussion https://github.com/stack-of-tasks/pinocchio/discussions/2849
    - Another discussion : https://github.com/stack-of-tasks/pinocchio/discussions/2850
        - Joris to check with Justin, Ajay ? (maybe Yann also)

#### simple-robotics/proxsuite

 - Items to discuss:
   - [#449 operator== for Settings, Info, and Results has duplicate comparisons and missing fields](https://github.com/Simple-Robotics/proxsuite/issues/449)
       - Bug in operator, PR provided by contributor. The person used GAI to find issues in proxsuite.
       - How to respond to that. Many projects refuse automatic PR generated by AI automatically.
       - How to have meaningful PRs ? (what's the problem behind)
       - Not the bandwidth to handle if project flooded by automatic PRs
       - improve Code of Conduct (human in the loop)
   - [#448 sparse maros meszaros using the API fail on eigen 5 on macos arm with nix](https://github.com/Simple-Robotics/proxsuite/issues/448)
       - Lucas to check (not an issue on Ubuntu, problem only on ARM MacOS)
       - change threshold ?
...
- [#794 Refactor CMake with JRL CMake Modules v2](https://github.com/coal-library/coal/pull/794)
   - Created 73 days ago, updated 2 days ago, no status
   - Need to change minor version in Coal/Eigenpy ?
   - For Coal, breaking changes so will be released after Pinocchio 4
   - Not for now
...
- [#2421 Passivity-based RNEA Algorithms](https://github.com/stack-of-tasks/pinocchio/pull/2421)
   - Created 523 days ago, updated 173 days ago, status to review

#### SIMPLE-ROBOTICS/ALIGATOR

- [#390 Fix building with upcoming Pinocchio 4](https://github.com/Simple-Robotics/aligator/pull/390)
   - Created 19 days ago, updated 11 days ago, no status
   - deprecated API - check if possible to have a compatibility layer or is really deprecated
   - to chwck later with Yann/Louis/Justin
- [#398 workflows/ubuntu : change build type to rel with deb info](https://github.com/Simple-Robotics/aligator/pull/398)
   - Created 3 days ago, updated 3 days ago, no status
   - Issue with a unit test which latest randomly indefinitely
   - Issue reproduced locally
   - This PR can be closed (not fixing the issue) but the problem should be investigated further in a dedicated issue (to be created by Joris)

#### SIMPLE-ROBOTICS/PROXSUITE

- [#434 flake.lock: Update](https://github.com/Simple-Robotics/proxsuite/pull/434)
   - Created 90 days ago, updated 12 days ago, no status
       - Lucas to create a side PR ? or change directly ?
       - Guilhem to work on this 
- [#437 Refactor CMake with JRL CMake Modules v2](https://github.com/Simple-Robotics/proxsuite/pull/437)
   - Created 73 days ago, updated 2 days ago, no status
   - Also waiting for review (same as others above)
...
- [#8 Added extended testing, separated tests and benchmarks](https://github.com/Simple-Robotics/LoIK/pull/8)
   - Created 561 days ago, updated 549 days ago, no status
   - internal work
   - Joris to add WIP label

### PR merged within the week

#### SIMPLE-ROBOTICS/ALIGATOR

- [#397 fix: use nu_max for du_tmp buffer allocation in tryLinearStep (#396)](https://github.com/Simple-Robotics/aligator/pull/397)
   - Created 3 days ago, merged 3 days ago
   - Bug found, fix provided.

#### SIMPLE-ROBOTICS/PROXSUITE

- [#450 Issue 449: fix various equality comparisons](https://github.com/Simple-Robotics/proxsuite/pull/450)
   - Created 5 days ago, merged 2 days ago
   - AI disclaimer
   - Is the operator actually used ? Not sure.
